...
export default function IntranetPage({ embedded = false }) {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f7f7f8' }}>
      {/* Standalone header — hidden when embedded inside AdminApp */}
      {!embedded && (
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            ...
            <div>
              <h1 style={{ margin: 0, fontSize: 20, fontWeight: 800 }}>Intranet</h1>
              <p style={{ margin: 0, fontSize: 12, color: '#9ca3af' }}>MindfulWayOS Staff Feed</p>
            </div>
          </div>
          <button
            onClick={signOut}
